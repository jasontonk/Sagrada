...
//		choosePane.setBackground(new Background(new BackgroundImage(new Image(getClass().getResource(url).toString()), null, null, null, null)));
		...
		rules.setText("\r\n" + 
				"Jullie zijn concurrerende artiesten die elk het mooiste\r\n" + 
				"glasraam in de Sagrada Familia willen smeden. Je\r\n" + 
				"glaspartijen zijn de dobbelstenen, die elk een kleur\r\n" + 
				"hebben, maar ook een tint die bepaald wordt door de\r\n" + 
				"waardes van de stenen (hoe kleiner de waarde, hoe\r\n" + 
				"lichter de tint).\r\n" + 
				"Elke ronde nemen de spelers dobbelstenen uit het\r\n" + 
				"aanbod en leggen ze die op hun glasraam. Hierbij\r\n" + 
				"moeten ze rekening houden met de voorwaarden op\r\n" + 
				"hun Patroonkaart: er mogen geen dobbelstenen van\r\n" + 
				"dezelfde kleur of waarde naast elkaar liggen.\r\n" + 
				"Na 10 rondes scoren de spelers punten op basis van\r\n" + 
				"hun gedeelde en persoonlijke doelen - de kunstenaar\r\n" + 
				"met de hoogste score is de winnaar!\r\n" + 
				"Overzicht\r\n" + 
				...
				"Leung, Stephen Sauer, Emily Tinawi, Nate Anderson, Brian Schrier, Evan Pedersen, Josh\r\n" + 
				"Slivken, Michael Guigliano, Dan Marta, Samuel Bailey, Curtis Clark, Kelsy Clark, Karl\r\n" + 
				"Liggin, Raul Taveras, Jax Sperling, Benny Sperling et “the\r\n" + 
				"Game Artisans of Canada”\r\n" + 
				"BEWERKING Emily Tinawi, Simon Rourke, David Castillo\r\n" + 
